...
// Self-hosted on GitHub, served via jsDelivr global CDN (1000+ edge locations, unlimited bandwidth, free).
const VIDEO_BASE = 'https://cdn.jsdelivr.net/gh/Shereen777/signbridge-videos@main/videos/';
...
function buildUrl(filename) {
  return VIDEO_BASE + filename + '.mp4';
}
